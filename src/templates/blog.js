        ...
        <Layout>
            ...
            <div className="inner-screen-container">
                <section className="blog-post-header" style={{
                    ...
                    to bottom,
                    rgba(0, 0, 0, 0.3), 
                    rgba(0, 0, 0, 0.8)), url(${props.data.contentfulBlog.featuredImage.fluid.src})`}}
                >
                    <p className="meta-tertiary">
                        <time class="date-published">{props.data.contentfulBlog.createdAt}</time>
                        <time class="date-updated">{props.data.contentfulBlog.updatedAt}</time>
                    </p>
                    <h1 className="headline">
                        {props.data.contentfulBlog.title}
                    </h1>
                    <p className="categories">
                        {props.data.contentfulBlog.topics.map(topic => (
                            <Link to={`/${topic.slug}/`} className="category">{topic.title}</Link>
                        ))}
                    </p>
                </section>
